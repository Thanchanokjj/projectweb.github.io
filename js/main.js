  ...
  $(function () {
    ...
    o(),
      ...
      (function () {
        ...
        // เมื่อคลิกที่ลิงก์ในเมนู Navbar
  $(".nav-item .nav-link").on("click", function () {
    var $navbarCollapse = $(".navbar-collapse");
    if ($navbarCollapse.hasClass("show")) {
      // ถ้าเมนู dropdown กำลังแสดง ให้ไม่ทำอะไรเลย
      return;
    } else {
      // ถ้าเมนู dropdown ไม่แสดง ให้แสดง
      $navbarCollapse.addClass("show");
    }
  });

  // เมื่อคลิกที่ลิงก์ในเมนู Dropdown
  $(".dropdown-item").on("click", function () {
    var $navbarCollapse = $(".navbar-collapse");
    if ($navbarCollapse.hasClass("show")) {
      // ถ้าเมนู dropdown กำลังแสดง ให้ซ่อนเมนู dropdown
      $navbarCollapse.removeClass("show");
    }
  });

  // เมื่อคลิกที่ลิงก์ในเมนู Dropdown Assignment1, Assignment2, Assignment3, หรือ Assignment4
  $(".dropdown-item:contains('Assignment1'), .dropdown-item:contains('Assignment2'), .dropdown-item:contains('Assignment3'), .dropdown-item:contains('Assignment4')").on("click", function () {
    var $navbarCollapse = $(".navbar-collapse");
    if ($navbarCollapse.hasClass("show")) {
      // ถ้าเมนู dropdown กำลังแสดง ให้ซ่อนเมนู dropdown
      $navbarCollapse.removeClass("show");
